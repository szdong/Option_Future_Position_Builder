...
def main():
    ...
    # option_1 = option_info(price=9300, option_type=option_type.CALL, lot=2, premium=269.0009, side=side.LONG)
    # future = future_info(price=9188, future_type=side.SHORT, lot=1)
    #
    # builder.add_option(option_info=option_1)
    # builder.add_future(future_info=future)
    ...
    builder.build_position(fee=fee, scale=200)
    plt.show()
